...
class Param {
 public:
  ...
  // double acc_bias_sigma = 0.000353;

  // double gyro_noise_sigma = 0.000031;  // rad/s * 1/sqrt(hz)
  // double acc_noise_sigma = 0.002119;   //　m/(s^2) * 1/sqrt(hz)

  double pixel_noise = 0;  // 1 pixel noise
  // cam f
  double fx = 460;
  double fy = 460;
  double cx = 255;
